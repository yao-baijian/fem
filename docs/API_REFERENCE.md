...
- [Solver Classes](#solver-classes)
  - [SBSolver](#sbsolver)
  - [SBPlacementSolver](#sbplacementsolver)
...
Simulated Bifurcation solver for Ising and QUBO problems.
...
**Parameters:**
- `mode` (str): 'discrete' or 'ballistic'
- `heated` (bool): Enable heated dynamics
...
**Parameters:**
- `J` (torch.Tensor): Coupling matrix
- `agents` (int): Number of parallel agents
...
High-level Simulated Bifurcation solver for placement problems.
...
SBPlacementSolver(
    mode: str = 'discrete',
    heated: bool = True,
    qubo_converter: Callable = None,
    coord_converter: Callable = None
)
```
...
- `mode` (str): 'discrete' or 'ballistic'
- `heated` (bool): Enable heated dynamics
- `qubo_converter` (callable): Function to convert J to QUBO matrix
- `coord_converter` (callable): Function to convert solution to coordinates
...
**Parameters:**
- `J` (torch.Tensor): Connectivity matrix
- `grid_info` (dict): Grid information (width, height, etc.)
- `agents` (int): Number of parallel agents
- `max_steps` (int): Maximum iterations

**Returns:**
- `tuple`: (coordinates, energy)
